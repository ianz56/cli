...
const CONFIG = {
	...
	providers: {
		...
		apple: {
			...
			desc: "Lyrics sourced from Apple Music via Paxsenix API. Supports sylable karaoke, synced, and unsynced lyrics. You can put your own <code>Paxsenix API key</code> to use this provider or leave blank to use the default API key.",
