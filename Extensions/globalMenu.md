...
Copy `globalMenu.js` to your Spicetify extensions folder or enable it directly:
...
The daemon is provided by the standalone [`spotify-globalmenu`](https://github.com/ianz56/spotify-globalmenu) project.
...
spotify-globalmenu --install-autostart

# To remove autostart at any time:
spotify-globalmenu --uninstall-autostart
```
...
2. Confirm the daemon is running (`pgrep -a spotify-globalmenu`).
